...
public void onCreate(SQLiteDatabase db){
    ...
    try{
        String CREATE_USERS_TABLE = "CREATE_TABLE" + USERS + "(" + COLUMN_ID + "INTEGER PRIMARY KEY AUTOINCRMENT," + COLUMN_NAME + "TEXT,"
...
public ArrayList<User> getUsers(){
    ...
    while(cursor.moveToNext()){
        ...
        String name = cursor.getString((int)cursor.getColumnIndex("name"));
        String password=cursor.getString((int)cursor.getColumnIndex("password"));
        User uset = new User (id,name,password);
        userList.add(user);
    }
    cursor.close();
    return userList;
